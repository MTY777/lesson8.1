...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Hacker jone_cena = new Hacker(200,20,10, "JC");
        Antman antman = new Antman(220,25,"Paul Rudd");
        Witcher wither = new Witcher(500, 0,"Herf");

        Hero[] heroes = {warrior, doc, magic, berserk, assistant, jone_cena, antman, wither};
